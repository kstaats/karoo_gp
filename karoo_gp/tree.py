...
class Tree:
    ...
    def __init__(self, id, root, tree_type='g', result=None):
        ...
        self.result = result or {}  # Reports generated by .evaluate
        self.bfs_ref = None
    ...
    @classmethod
    def generate(cls, log, pause, error, id, tree_type, tree_depth_base,
    ...
    def copy(self, id=None, include_result=False):
        '''Return a duplicate, all attributes/state'''
        args = (id if id is not None else self.id,
                self.root.copy(),
                self.tree_type,
                self.result if include_result else None)
        return Tree(*args)
    ...
    def __repr__(self):
        fit_repr = f" fitness: {self.fitness}" if self.fitness else ''
    ...
    def fitness(self):
        ...
        fitness = self.result.get('fitness')
